...
public class EmailService {
    // private final static String EMAIL_CONFIRMATION_SUBJECT = "Book Rental Request
    // Approved";
    ...
    public void sendRequestAcceptedEmail(Request request) {
        ...
        LocalDate requestDate = LocalDate.parse(request.getDateOfRequest(), formatter);
        LocalDate returnDate = LocalDate.parse(request.getDateOfReturn(), formatter);
        LocalDate pickUpDate = LocalDate.parse(request.getDateOfAccepted(), formatter);
        LocalDate nextDay = pickUpDate.plusDays(1);

        // Build the HTML email content
        StringBuilder htmlContentBuilder = new StringBuilder();
        htmlContentBuilder.append("<!doctype html><html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head><title></title><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><!--<![endif]--><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><style type=\"text/css\">#outlook a { padding:0; }\n");
        ...
        htmlContentBuilder.append("p { display:block;margin:13px 0; }</style><style type=\"text/css\">@media only screen and (max-width:480px) {\n");
        htmlContentBuilder.append("@-ms-viewport { width:320px; }\n");
        htmlContentBuilder.append("@viewport { width:320px; }\n");
        htmlContentBuilder.append("}</style><link href=\"https://fonts.googleapis.com/css2?family=Poppins\" rel=\"stylesheet\" type=\"text/css\"><style type=\"text/css\">@import url(https://fonts.googleapis.com/css2?family=Poppins);</style><style type=\"text/css\">@media only screen and (min-width:480px) {\n");
        ...
        .append(author)
        .append("</span></div></td></tr></table></td></tr></tbody></table></div><div class=\"mj-column-per-100 outlook-group-fix\" style=\"font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" width=\"100%\"><tbody><tr><td style=\"vertical-align:top;padding-top:5px;padding-bottom:5px;\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" width=\"100%\"><tr><td align=\"left\" style=\"font-size:0px;padding:10px 25px;word-break:break-word;\"><div style=\"font-family:Poppins;font-size:16px;line-height:normal;text-align:left;color:#000000;\"><ul style=\"margin: 0; padding: 0\"><li style=\"margin: 0 0 1em; list-style: disc inside;\n");
    ...
    public void sendRequestRejectedEmail(Request request) {
        ...
        htmlContentBuilder.append(".ExternalClass * { line-height:100%; }\n");
        htmlContentBuilder
                .append("body { margin:0;padding:0;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%; }\n");
        htmlContentBuilder
                .append("table, td { border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt; }\n");
        htmlContentBuilder.append(
        ...
        htmlContentBuilder.append(
                "<link href='https://fonts.googleapis.com/css2?family=Poppins' rel='stylesheet' type='text/css'><style type='text/css'>@import url(https://fonts.googleapis.com/css2?family=Poppins);</style><!--<![endif]--><style type='text/css'>@media only screen and (min-width:480px) {\n");
        htmlContentBuilder.append(".mj-column-per-100 { width:100% !important; max-width: 100%; }\n");
        htmlContentBuilder.append(".mj-column-px-500 { width:500px !important; max-width: 500px; }\n");
        htmlContentBuilder.append("}</style><style type='text/css'>@media only screen and (max-width:480px) {\n");
        htmlContentBuilder.append("table.full-width-mobile { width: 100% !important; }\n");
        ...
        htmlContentBuilder.append(
                "mso-special-format: bullet;'><span style='font-weight: 700'>Reject Reason:</span></li></ul></div></td></tr></table></td></tr></tbody></table></div><!--[if mso | IE]></td><td class='poster-outlook' style='vertical-align:top;width:500px;' ><![endif]--><div class='mj-column-px-500 outlook-group-fix poster' style='font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%'><tbody><tr><td style='background-color:rgba(208, 180, 159, 0.2);vertical-align:top;padding:20px;padding-top:10px;padding-bottom:10px;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' width='100%'><tr><td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;'><div style='font-family:Poppins;font-size:16px;line-height:normal;text-align:left;color:#000000;'>")
        ...
        htmlContentBuilder.append(
                "</td></tr></table><![endif]--></td></tr></table></div><!--[if mso | IE]></td><td class='' style='vertical-align:top;width:600px;' ><![endif]--><div class='mj-column-per-100 outlook-group-fix' style='font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'><tr><td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'><!--[if mso | IE]><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' ><tr><td><![endif]--><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='float:none;display:inline-table;'><tr><td style='padding:4px;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#A37551;border-radius:3px;width:40px;'><tr><td style='font-size:0;height:40px;vertical-align:middle;width:40px;'><a href='https://www.facebook.com/sharer/sharer.php?u=https://kjeybook.vercel.app' target='_blank'><img height='40' src='https://www.mailjet.com/images/theme/v1/icons/ico-social/facebook.png' style='border-radius:3px;' width='40'></a></td></tr></table></td></tr></table><!--[if mso | IE]></td><td><![endif]--><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='float:none;display:inline-table;'><tr><td style='padding:4px;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#A37551;border-radius:3px;width:40px;'><tr><td style='font-size:0;height:40px;vertical-align:middle;width:40px;'><a href='https://kjeybook.vercel.app' target='_blank'><img height='40' src='https://www.mailjet.com/images/theme/v1/icons/ico-social/instagram.png' style='border-radius:3px;' width='40'></a></td></tr></table></td></tr></table><!--[if mso | IE]></td><td><![endif]--><table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='float:none;display:inline-table;'><tr><td style='padding:4px;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#A37551;border-radius:3px;width:40px;'><tr><td style='font-size:0;height:40px;vertical-align:middle;width:40px;'><a href='https://twitter.com/home?status=https://kjeybook.vercel.app' target='_blank'><img height='40' src='https://www.mailjet.com/images/theme/v1/icons/ico-social/twitter.png' style='border-radius:3px;' width='40'></a></td></tr></table></td></tr></table><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></table></div><!--[if mso | IE]></td><td class='' style='vertical-align:top;width:600px;' ><![endif]--><div class='mj-column-per-100 outlook-group-fix' style='font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;'><table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'><tr><td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'><div style='font-family:Poppins;font-size:12px;line-height:normal;text-align:center;color:#000000;'>© 2023 Kjey Book. All rights reserved.</div></td></tr></table></div><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><![endif]--></div></body></html>\n");
    ...
    public void sendResetPasswordEmail(String email, String resetPwdToken, LocalDateTime expirationTime) {
        ...
        String resetLink = "https://example.com/reset-password?email=" + existingUser.getEmail() + "&token="
                + resetPwdToken;
        ...
        String message = "Hello " + existingUser.getUsername() + ",\n\n" +
                ...
                resetLink + "\n\n" +
                "Please note that this link will expire in " + expirationTime
                + ". If you do not reset your password within this timeframe, you will need to submit another password reset request.\n\n"
                +
